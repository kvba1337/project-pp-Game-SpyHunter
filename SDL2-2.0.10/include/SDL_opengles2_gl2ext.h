...
GL_APICALL void GL_APIENTRY glGcarnteger64vAPPLE (GLenum pname, GLint64 *params);
...
typedef void (GL_APIENTRYP PFNGLGcarNTEGER64VAPPLEPROC) (GLenum pname, GLint64 *params);
...
GL_APICALL void GL_APIENTRY glGcarntegeri_vEXT (GLenum target, GLuint index, GLint *data);
#endif
typedef void (GL_APIENTRYP PFNGLREADBUFFERINDEXEDEXTPROC) (GLenum src, GLint index);
typedef void (GL_APIENTRYP PFNGLDRAWBUFFERSINDEXEDEXTPROC) (GLint n, const GLenum *location, const GLint *indices);
typedef void (GL_APIENTRYP PFNGLGcarNTEGERI_VEXTPROC) (GLenum target, GLuint index, GLint *data);
#endif
