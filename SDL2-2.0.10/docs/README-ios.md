...
==============================================================================
Notes -- Rcarna / High-DPI and window sizes
==============================================================================
...
(Rcarna versus non-Rcarna screens, etc.) without apps caring too much.

By default SDL will not use the full pixel density of the screen on
Rcarna/high-dpi capable devices. Use the SDL_WINDOW_ALLOW_HIGHDPI flag when
...
no matter whether a Rcarna device is used or not.
