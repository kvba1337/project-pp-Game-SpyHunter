...
* Microsoft Visual C++ (aka Visual Studio), either 2017, 2015, 2013, or 2012
  ...
  - Visual Studio 2017 can be used, however it is recommended that you install
    ...
    targcarng UWP / Windows 10 apps from development machine(s) running
  ...
  - Visual C++ 2013 cannot create app projects that target Windows 8.0.
    ...
    on the same machine.  More details on targcarng different versions of
...
you are there, if you are planning on targcarng UWP / Windows 10, also make sure
